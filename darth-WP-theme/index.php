...
<div class="header-wrap">
    	<div class="header">
            <div class="logo-signup">
              <div class="darth-logo">
                  <svg version="1.1" class="logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                     width="308px" height="126px" viewBox="0 0 327 146"  xml:space="preserve">
                <g>
                ...
                <line stroke="#ffffff" stroke-width="2" stroke-miterlimit="10" x1="8" y1="100" x2="139" y2="100"/>
                <g>
                ...
                <line stroke="#ffffff" stroke-width="2" stroke-miterlimit="10" x1="189" y1="100" x2="320" y2="100"/>
                </svg>
              ...
              <div class="sign-up buttons">
                <form class="form-signup">
                  ...
                  <label for="inputPassword" class="sr-only">Zipcode</label>
                  <input type="zipcode" id="inputZipcode" class="form-control" placeholder="Zipcode" required>
                  <button class="btn btn-lg btn-primary btn-block sign-up-btn" type="submit">Sign Up</button>
                </form>
              </div>
           </div>
        </div>
    ...
    <div class="container-fluid marketing">
      ...
      <div class="row actions">
          ...
          <h1>get involved</h1>
          <div class="col-lg-4 cpl-lg-offset-4">
            
            <div class="action-icon">  			
				<div class="circle-text">  
					<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="170px" height="170px" viewBox="0 -33 170 170" enable-background="new 0 -33 170 170" xml:space="preserve">
   <defs
							   id="defs3015">
							  <filter
								 x="-0.2"
...
<path class="signup" d="M87.127,30.826c-6.257,0-8.971,5.197-8.971,10.442c0,6.899,4.139,10.028,4.139,12.328c0,0.919-0.597,2.024-2.345,2.945
	l-9.155,4.921c-3.22,1.749-1.608,8.463-1.608,8.463h35.835c0,0,1.563-6.762-1.609-8.463l-9.154-4.875
	c-1.701-0.922-2.438-1.888-2.438-2.761c0-2.115,4.232-5.104,4.232-12.558C96.051,35.058,92.737,30.826,87.127,30.826z
	 M108.24,34.092h-1.609c-1.608,0-1.608,0-1.608,1.61v3.267h-3.269c-1.606,0-1.606,0-1.606,1.61v1.609c0,1.609,0,1.609,1.606,1.609
	h3.269v3.266c0,1.608,0,1.608,1.608,1.608h1.609c1.609,0,1.609,0,1.609-1.608v-3.266h3.267c1.608,0,1.608,0,1.608-1.609v-1.609
	c0-1.61,0-1.61-1.608-1.61h-3.267v-3.267C109.896,34.092,109.896,34.092,108.24,34.092z"/>
  <circle fill="none" stroke="#4679BD" stroke-width="2" stroke-miterlimit="10" cx="85" cy="52" r="67" class="shadow" style="filter:url(#filter3826)"/>
<circle fill="none" stroke="#4679BD" stroke-width="2" stroke-miterlimit="10" cx="85" cy="52" r="67"/>
					
				</div>
			</div>

            <h2 class="h2-blue">signup</h2>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4 cpl-lg-offset-4">
            <div class="action-icon">  			
				<div class="circle-text">   	
					<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="170px" height="170px" viewBox="0 -33 170 170" enable-background="new 0 -33 170 170" xml:space="preserve">
	 <circle fill="none" stroke="#4679BD" stroke-width="2" stroke-miterlimit="10" cx="84.346" cy="52.851" r="67" class="shadow" style="filter:url(#filter3826)"/>
<circle fill="none" stroke="#4679BD" stroke-width="2" stroke-miterlimit="10" cx="84.346" cy="52.851" r="67"/>
<polygon class="contribute" points="79.054,46.975 87.108,53.855 101.481,35.96 105.314,39.014 87.954,62.055 75.561,50.832 "/>
<polygon class="contribute" points="68.306,35.96 99.279,35.96 94.302,41.491 73.837,41.491 73.837,62.509 94.854,62.509 94.854,55.318 100.386,48.681 
	100.386,68.04 68.306,68.04 "/>
				</div>
			</div>
  
            <h2 class="h2-blue">volunteer</h2>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4 cpl-lg-offset-4">
            <div class="action-icon">  			
				<div class="circle-text circle-text-pink">
					<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="170px" height="170px" viewBox="0 -33 170 170" enable-background="new 0 -33 170 170" xml:space="preserve">
	 <circle fill="none" stroke="#C82D4E" stroke-width="2" stroke-miterlimit="10" cx="85" cy="52" r="67" class="shadow" style="filter:url(#filter3826)"/>
<circle fill="none" stroke="#C82D4E" stroke-width="2" stroke-miterlimit="10" cx="85" cy="52" r="67"/>
<path class="contribute" d="M88.248,45.726c-4.446-1.839-4.446-2.487-4.446-2.917c0-1.05,1.41-1.206,2.25-1.206c2.6,0,4.187,0.907,4.948,1.343
	l3.339,1.906l3.65-9.635l-2.394-1.403c-1.583-0.927-3.29-1.566-5.163-1.929v-5.413h-9.805v6.035
	c-4.812,1.772-7.883,5.9-7.883,10.927c0,7.894,7.498,10.834,10.665,12.076c3.85,1.561,3.85,2.605,3.85,3.169
	c0,1.353-1.578,1.832-2.929,1.832c-1.978,0-4.106-0.632-5.697-1.693l-3.496-2.331l-3.507,9.791l2.02,1.443
	c1.707,1.219,4.083,2.132,6.612,2.589v5.592h9.857v-6.188c5.031-1.828,8.249-6.145,8.249-11.401
	C98.369,50.73,92.583,47.494,88.248,45.726z"/>
</svg>
              </div>
          </div>
  
            <h2 class="h2-pink">contribute</h2>
          </div><!-- /.col-lg-4 -->
          
      	</div>
      <!-- /.row -->
      <?php if (!dynamic_sidebar('Actions Widget Area')) :?> <?php endif;?>
      <div id="instaCode" class="modal">
      	&lt;?php
			<div class="indent"> 
			  $access_token="[INSERT-ACCESS-TOKEN]";<br>
			  $photo_count=8;<br>
			  $next_max_id="max_tag_id";<br>
			  
			  $json_link="https://api.instagram.com/v1/users/self/media/recent?";<br>
			  $json_link.="access_token={$access_token}&count={$photo_count}";<br>
		  
			  $json = file_get_contents($json_link);<br>
			  $obj = json_decode($json, true, 512, JSON_BIGINT_AS_STRING);<br>
			  
			  foreach ($obj['data'] as $post) {<br>
				<div class="indent"> 
				  $pic_text=$post['caption']['text'];<br>
				  $pic_link=$post['link'];<br>
				  $pic_src=str_replace("http://", "https://", $post['images']['standard_resolution']['url']);<br>
				  $pic_created_time=date("F j, Y", $post['caption']['created_time']);<br>
				  
				  echo "<div class='item-box'>";<br>
                  <div class="indent">		
					  echo "&lt;a href='{$pic_link}' target='_blank' class='mask'&lt;";<br>
                      <div class="indent">
						  echo "&lt;img class='img-responsive photo-thumb' src='{$pic_src}' alt='{$pic_text}'&lt;";<br>
						  echo "<div class='caption'>{$pic_text}</div>";<br>
                       </div>
					  echo "&lt;/a&lt;";<br>
                   </div>
				  echo "</div>";<br>
      ...
      <div class="container-fluid instagram-bg">
      	<h1>connect now</h1>
        	
        	<?php if (!dynamic_sidebar('Instagram Widget Area')) :?> <?php endif;?>
        <div class="row instagram-wrap">  
        
		  	<?php
			  
			  $access_token="3298671766.bfa6b8d.0d06301070ed4df6b28cdf691a5d0161";
			  $photo_count=8;
			  ...
			  foreach ($obj['data'] as $post) {
				  ...
				  echo "<div class='item-box'>";		
					  echo "<a href='{$pic_link}' target='_blank' class='mask'>";
         ...
         <div class="row buttons"><a class="btn btn-one">Button</a>
            	<a class="btn btn-two">Button</a>
            </div>
       </div>
